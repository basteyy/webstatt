...
<script src="<?= $this->getAbsoluteUrl('/assets/js/confirmbutton.min.js') ?>"></script>
<script src="<?= $this->getAbsoluteUrl('/assets/js/clipboard.min.js') ?>"></script>
<script src="<?= $this->getAbsoluteUrl('/assets/js/webstatt.js') ?>"></script>
